                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11 mb-5">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action ="SvCiudadano" method="post" class="row g-3 mt-3 needs-validation">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" pattern="[0-9]{8}[A-Za-z]" id="validarDni" name="validarDni" required>
                                                <div class="valid-feedback">Válido.</div>
                                                <div class="invalid-feedback">Ingresa un valor válido.</div>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="validarTelefono" class="form-label">Telefono</label>
                                                <input type="text" required pattern="[0-9]+" class="form-control" id="validarTelefono" name="validarTelefono" requires>
                                                <div class="valid-feedback">Válido.</div>
                                                <div class="invalid-feedback">Ingresa un valor válido.</div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <%} else if (request.getAttribute("registroCorrecto") != null) {%>
